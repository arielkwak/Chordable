...
//  Code adapted from https://github.com/Peter-Schorn/SpotifyAPIExampleApp/blob/main/SpotifyAPIExampleApp/Model/Spotify.swift
...
final class Spotify: ObservableObject {
  ...
  let loginCallbackURL = URL(
    string: "chordable://login-callback"
  )!
  ...
  let keychain = Keychain(service: "com.minjooki2.chordable")
